...
class DuplicateDetector:
    ...
    def __init__(self, 
        ...
        if not self.hash_algorithm in ('md5', 'sha256'):
    ...
    def find_duplicate_files(self, directories: List[pathlib.Path], 
                           recursive: bool = True,
                           extensions: Optional[Set[str]] = None) -> Dict[str, List[pathlib.Path]]:
