...
def is_valid_dst_difference(metadata_time: datetime.datetime, 
                          reference_time: datetime.datetime,
                          timezone_name: str = "Europe/Berlin") -> Tuple[bool, Optional[str]]:
    """
    ...
    if abs(time_diff_seconds - expected_dst_diff) <= 10:  # Allow 10 second tolerance
        ...
        elif expected_dst_diff == -3600:
            return True, "1-hour DST fall back transition"
        elif expected_dst_diff != 0:
