...
class FileOperations:
    ...
    def execute_batch_operations(self, operations: List[FileOperation]) -> Tuple[List[OperationResult], List[OperationResult]]:
    ...
    def plan_operation(self, source_path: pathlib.Path, target_path: pathlib.Path, 
                      operation_type: OperationType, identifier: str = "") -> FileOperation:
    ...
    def plan_batch_operations(self, file_mappings: Dict[pathlib.Path, pathlib.Path], 
                            operation_type: OperationType) -> List[FileOperation]:
    ...
    def _is_cross_drive_error(self, error: OSError) -> bool:
        ...
        return (
            "different disk drive" in error_str or 
            error.errno == 17 or  # Cross-device link error
            "cross-device link" in error_str
        )
